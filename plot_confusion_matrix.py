...
if __name__ == "__main__":
    ...
    #                             [3704,320,3604,46],
    #                             [1144,33,598,88]])]
    confusion_matrix = np.load("/data/jiaaodong/conti_new/target_data_True_1562152496_crop_5/Schumann/cluster_confusion.npy")

    
        # Plot non-normalized confusion matrix
    plot_confusion_matrix(confusion_matrix, classes=class_names,
                        title='DBSCAN clustering method')



    # plt.show()
    plt.savefig("/data/jiaaodong/conti_new/target_data_True_1562152496_crop_5/Schumann/cluster_confusion.png")
